...
Idea1: Start with each attribute on its own, but as a set. At each step,
consider  merging two existing sets, but pick the pair that results in the 
maximum reduction in query cost per overhead removed.
