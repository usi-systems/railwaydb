...
void VsTimeDeltaBFS::tearDown()
{

}

void VsTimeDeltaBFS::makeEdgeIOCountExp(ExperimentalData * exp)
{
...
void VsTimeDeltaBFS::makeEdgeWriteIOCountExp(ExperimentalData * exp)
{
...
void VsTimeDeltaBFS::makeEdgeReadIOCountExp(ExperimentalData * exp) {
